...
function createDeflateEncoder(configuration, worker, streamId) {
    ...
    function consumeResult() {
        var output = compressedData.length === 0 ? new Uint8Array(0) : (0, browser_core_1.concatBuffers)(compressedData.concat(compressedDataTrailer));
        var result = {
    ...
    return {
        ...
        finishSync: function () {
            ...
            var pendingData = pendingWriteActions
                ...
                .join('');
            return (0, browser_core_1.assign)(consumeResult(), {
